...
| --------- | --------------- | ------------ | --------- |
| MLAG_BE_LEAF_01 | Vlan4094 | 10.118.4.252 | Port-Channel1000 |
...
mlag configuration
   ...
   peer-address heartbeat 10.118.5.116 vrf PCS-NETINFRA-OOB
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1/1 | SERVER_gpu1-01_7/1 | trunk | 1300 | 1000 | - | - |
| Ethernet1/2 | SERVER_gpu1-02_7/1 | trunk | 1300 | 1000 | - | - |
| Ethernet23/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet23/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet24/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet24/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet25/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet25/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet26/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet26/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet27/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet27/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet28/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet28/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet29/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet29/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet30/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet30/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet31/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet31/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet32/1 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet32/1 | *trunk | *- | *- | *MLAG | 1000 |
...
interface Ethernet1/1
   description SERVER_gpu1-01_7/1
   no shutdown
...
interface Ethernet1/2
   description SERVER_gpu1-02_7/1
   no shutdown
   switchport trunk native vlan 1000
   switchport trunk allowed vlan 1300
   switchport mode trunk
...
interface Ethernet23/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet23/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet24/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet24/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet25/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet25/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet26/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet26/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet27/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet27/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet28/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet28/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet29/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet29/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet30/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet30/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet31/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet31/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet32/1
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Ethernet32/1
   no shutdown
   channel-group 1000 mode active
```
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1000 | MLAG_KDC-AR7060X6-PCS-BELEAF1_Port-Channel1000 | trunk | - | - | MLAG | - | - | - | - |
...
interface Port-Channel1000
   description MLAG_KDC-AR7060X6-PCS-BELEAF1_Port-Channel1000
   no shutdown
   switchport mode trunk
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ------ | ------- |
| Vlan4093 |  default  |  10.118.4.245/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.118.4.244 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 1000 | 10.118.0.6:11000 | 11000:11000 | - | - | learned |
| 1300 | 10.118.0.6:11300 | 11300:11300 | - | - | learned |
...
router bgp 65372
   ...
   neighbor 10.118.4.244 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.118.4.244 description KDC-AR7060X6-PCS-BELEAF1_Vlan4093
