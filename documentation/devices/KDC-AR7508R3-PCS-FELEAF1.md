...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1/1 | OOB_MANAGEMENT | oob | PCS-NETINFRA-OOB | 10.118.5.16/24 | 10.118.5.254 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3/21/1 | MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/21/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet3/22/1 | MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/22/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet3/23/1 | MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/23/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet3/24/1 | MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/24/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet4/1/1 | SERVER_CPU1-01_6/1 | trunk | - | 1000 | - | - |
| Ethernet6/1 | SERVER_CPU1-01_0/1 | trunk | - | 1000 | - | - |
| Ethernet6/40/1 | LOAD_BALANCER_01_3.0 | *trunk | *- | *1000 | *- | 1640 |
| Ethernet6/41/1 | LOAD_BALANCER_01_5.0 | *trunk | *- | *1000 | *- | 1640 |
| Ethernet6/42/1 | LOAD_BALANCER_02_3.0 | *trunk | *- | *1000 | *- | 1642 |
| Ethernet6/43/1 | LOAD_BALANCER_02_5.0 | *trunk | *- | *1000 | *- | 1642 |
...
| Ethernet6/46/1 | FIREWALL_perimerter-01_32 | *trunk | *1015-1016 | *1000 | *- | 1646 |
...
| Ethernet7/40/1 | LOAD_BALANCER_01_7.0 | *trunk | *- | *1000 | *- | 1640 |
| Ethernet7/41/1 | LOAD_BALANCER_01_9.0 | *trunk | *- | *1000 | *- | 1640 |
| Ethernet7/42/1 | LOAD_BALANCER_02_7.0 | *trunk | *- | *1000 | *- | 1642 |
| Ethernet7/43/1 | LOAD_BALANCER_02_9.0 | *trunk | *- | *1000 | *- | 1642 |
...
| Ethernet7/46/1 | FIREWALL_perimerter-02_32 | *trunk | *1015-1016 | *1000 | *- | 1746 |
| Ethernet7/47/1 | ROUTER_Internet-CPE-01_2 | access | 1018 | - | - | - |
| Ethernet7/48/1 | ROUTER_MPLS-CPE-01_5 | access | 1017 | - | - | - |
| Ethernet7/49/1 | MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet7/49/1 | *trunk | *- | *- | *MLAG | 1000 |
| Ethernet7/50/1 | MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet7/50/1 | *trunk | *- | *- | *MLAG | 1000 |
...
interface Ethernet3/21/1
   description MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/21/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet3/22/1
   description MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/22/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet3/23/1
   description MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/23/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet3/24/1
   description MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet3/24/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet4/1/1
   description SERVER_CPU1-01_6/1
   no shutdown
...
interface Ethernet6/1
   description SERVER_CPU1-01_0/1
   no shutdown
   switchport trunk native vlan 1000
   switchport mode trunk
   switchport
...
interface Ethernet7/41/1
   description LOAD_BALANCER_01_9.0
   no shutdown
   channel-group 1640 mode active
!
interface Ethernet7/42/1
   description LOAD_BALANCER_02_7.0
   no shutdown
   channel-group 1642 mode active
!
interface Ethernet7/43/1
   description LOAD_BALANCER_02_9.0
   no shutdown
   channel-group 1642 mode active
!
interface Ethernet7/44/1
   description FIREWALL_DC-01_28
   no shutdown
   speed forced 10000full
   channel-group 1644 mode active
!
interface Ethernet7/45/1
   description FIREWALL_DC-02_28
   no shutdown
   speed forced 10000full
   channel-group 1645 mode active
!
...
interface Ethernet7/48/1
   description ROUTER_MPLS-CPE-01_5
   no shutdown
   speed forced 1000full
...
interface Ethernet7/49/1
   description MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet7/49/1
   no shutdown
   channel-group 1000 mode active
!
interface Ethernet7/50/1
   description MLAG_KDC-AR7508R3-PCS-FELEAF2_Ethernet7/50/1
   no shutdown
   channel-group 1000 mode active
```
...
interface Port-Channel1000
   description MLAG_KDC-AR7508R3-PCS-FELEAF2_Port-Channel1000
   no shutdown
   switchport mode trunk
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.118.0.3/32 |
...
| Vlan1012 | KDC iDrac-to-MPLS | PCS-MPLS-INTRANET | 9200 | False |
...
| Vlan1010 |  PCS-SHARED-INTERNET  |  10.118.2.36/29  |  -  |  10.118.2.38  |  -  |  -  |
| Vlan1011 |  PCS-SHARED-INTERNET  |  10.118.2.52/29  |  -  |  10.118.2.54  |  -  |  -  |
| Vlan1012 |  PCS-MPLS-INTRANET  |  10.118.2.60/29  |  -  |  10.118.2.62  |  -  |  -  |
| Vlan1013 |  PCS-SHARED-INTERNET  |  10.118.2.100/29  |  -  |  10.118.2.102  |  -  |  -  |
| Vlan1014 |  PCS-MPLS-INTRANET  |  10.118.2.140/29  |  -  |  10.118.2.142  |  -  |  -  |
| Vlan1015 |  PCS-MPLS-INTRANET  |  10.118.2.68/29  |  -  |  10.118.2.70  |  -  |  -  |
| Vlan1016 |  PCS-SHARED-INTERNET  |  10.118.2.76/29  |  -  |  10.118.2.78  |  -  |  -  |
| Vlan1019 |  PCS-MPLS-INTRANET  |  10.118.2.116/29  |  -  |  10.118.2.118  |  -  |  -  |
| Vlan1022 |  PCS-MPLS-INTRANET  |  10.118.22.252/24  |  -  |  10.118.22.254  |  -  |  -  |
| Vlan1023 |  PCS-MPLS-INTRANET  |  10.118.23.252/24  |  -  |  10.118.23.254  |  -  |  -  |
| Vlan1024 |  PCS-MPLS-INTRANET  |  10.118.24.252/24  |  -  |  10.118.24.254  |  -  |  -  |
| Vlan1027 |  PCS-MPLS-INTRANET  |  10.118.27.252/24  |  -  |  10.118.27.254  |  -  |  -  |
| Vlan1051 |  PCS-MPLS-INTRANET  |  10.118.51.252/24  |  -  |  10.118.51.254  |  -  |  -  |
...
interface Vlan1011
   ...
   mtu 9200
   vrf PCS-SHARED-INTERNET
   ip address 10.118.2.52/29
   ip virtual-router address 10.118.2.54
!
interface Vlan1012
   description KDC iDrac-to-MPLS
   no shutdown
   mtu 9200
   vrf PCS-MPLS-INTRANET
   ip address 10.118.2.60/29
...
!
interface Vxlan1
   description KDC-AR7508R3-PCS-FELEAF1_VTEP
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.118.4.253 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.118.4.251 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PCS-MPLS-INTRANET | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.118.4.249 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER
| 1163 | 10.118.0.3:11163 | 11163:11163 | - | - | learned |
| 1164 | 10.118.0.3:11164 | 11164:11164 | - | - | learned |
| 1165 | 10.118.0.3:11165 | 11165:11165 | - | - | learned |
| 1166 | 10.118.0.3:11166 | 11166:11166 | - | - | learned |
| 1167 | 10.118.0.3:11167 | 11167:11167 | - | - | learned |
| 1168 | 10.118.0.3:11168 | 11168:11168 | - | - | learned |
| 1169 | 10.118.0.3:11169 | 11169:11169 | - | - | learned |
| 1200 | 10.118.0.3:11200 | 11200:11200 | - | - | learned |
| 1201 | 10.118.0.3:11201 | 11201:11201 | - | - | learned |
| 1202 | 10.118.0.3:11202 | 11202:11202 | - | - | learned |
| 1203 | 10.118.0.3:11203 | 11203:11203 | - | - | learned |
| 1204 | 10.118.0.3:11204 | 11204:11204 | - | - | learned |
| 1205 | 10.118.0.3:11205 | 11205:11205 | - | - | learned |
| 1206 | 10.118.0.3:11206 | 11206:11206 | - | - | learned |
| 1301 | 10.118.0.3:11301 | 11301:11301 | - | - | learned |
| 1302 | 10.118.0.3:11302 | 11302:11302 | - | - | learned |
| 1304 | 10.118.0.3:11304 | 11304:11304 | - | - | learned |
| 1309 | 10.118.0.3:11309 | 11309:11309 | - | - | learned |
| 1310 | 10.118.0.3:11310 | 11310:11310 | - | - | learned |
| 1311 | 10.118.0.3:11311 | 11311:11311 | - | - | learned |
| 1350 | 10.118.0.3:11350 | 11350:11350 | - | - | learned |
| 1351 | 10.118.0.3:11351 | 11351:11351 | - | - | learned |
| 1501 | 10.118.0.3:11501 | 11501:11501 | - | - | learned |
| 2000 | 10.118.0.3:12000 | 12000:12000 | - | - | learned |
| 2005 | 10.118.0.3:12005 | 12005:12005 | - | - | learned |
| 2006 | 10.118.0.3:12006 | 12006:12006 | - | - | learned |
| 2007 | 10.118.0.3:12007 | 12007:12007 | - | - | learned |
| 2008 | 10.118.0.3:12008 | 12008:12008 | - | - | learned |
| 2009 | 10.118.0.3:12009 | 12009:12009 | - | - | learned |
| 2010 | 10.118.0.3:12010 | 12010:12010 | - | - | learned |
| 2011 | 10.118.0.3:12011 | 12011:12011 | - | - | learned |
| 2012 | 10.118.0.3:12012 | 12012:12012 | - | - | learned |
| 2013 | 10.118.0.3:12013 | 12013:12013 | - | - | learned |
| 2014 | 10.118.0.3:12014 | 12014:12014 | - | - | learned |
| 2015 | 10.118.0.3:12015 | 12015:12015 | - | - | learned |
| 2016 | 10.118.0.3:12016 | 12016:12016 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| PCS-MPLS-INTRANET | 10.118.0.3:10 | connected | - |
| PCS-SHARED-INTERNET | 10.118.0.3:11 | connected | - |
...
router bgp 65371
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description KDC-AR7508R3-PCS-FELEAF2
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER password 7 <removed>
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.118.4.253 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.118.4.253 description KDC-AR7508R3-PCS-FELEAF2_Vlan4093
   ...
   vrf PCS-SHARED-INTERNET
      ...
      router-id 10.118.0.3
      neighbor 10.118.4.249 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.118.4.249 description KDC-AR7508R3-PCS-FELEAF2_Vlan4091
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
