...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | PCS-NETINFRA-OOB | 10.118.5.116/24 | 10.118.5.254 |
...
!
interface Vxlan1
   description KDC-AR7060X6-PCS-BELEAF1_VTEP
...
router bgp 65372
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description KDC-AR7060X6-PCS-BELEAF2
